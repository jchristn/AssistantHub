  ...
  return (
    <div className="topbar" data-tour-target="topbar-misc">
      <div className="topbar-left">
        <span className="topbar-badge server">
          {serverUrl}
          <button
      ...
      <div className="topbar-right">
        ...
        <a href="https://github.com/jchristn/assistanthub" target="_blank" rel="noopener noreferrer" className="theme-toggle" title="GitHub">
