namespace AssistantHub.Core.Database.Mysql.Implementations
{
    ...
    /// <summary>
    /// MySQL assistant settings methods implementation.
    /// </summary>
    public class AssistantSettingsMethods : IAssistantSettingsMethods
    {
        ...
        public AssistantSettingsMethods(MysqlDatabaseDriver driver, DatabaseSettings settings, LoggingModule logging)
        {
        ...
        public async Task<AssistantSettings> CreateAsync(AssistantSettings settings, CancellationToken token = default)
        {
            ...
            string query =
                ...
                (settings.EnableReranking ? 1 : 0) + ", " +
                settings.RerankerTopK + ", " +
                _Driver.FormatDouble(settings.RerankerScoreThreshold) + ", " +
                ...
                _Driver.FormatNullableString(settings.ToolRoutingInferenceEndpointId) + ", " +
                ...
                _Driver.FormatNullableString(settings.RetrievalLabelFilter) + ", " +
        ...
        public async Task<AssistantSettings> UpdateAsync(AssistantSettings settings, CancellationToken token = default)
        {
            ...
            string query =
                ...
                "enable_reranking = " + (settings.EnableReranking ? 1 : 0) + ", " +
                "reranker_top_k = " + settings.RerankerTopK + ", " +
                "reranker_score_threshold = " + _Driver.FormatDouble(settings.RerankerScoreThreshold) + ", " +
                ...
                "tool_routing_inference_endpoint_id = " + _Driver.FormatNullableString(settings.ToolRoutingInferenceEndpointId) + ", " +
                ...
                "retrieval_label_filter = " + _Driver.FormatNullableString(settings.RetrievalLabelFilter) + ", " +
