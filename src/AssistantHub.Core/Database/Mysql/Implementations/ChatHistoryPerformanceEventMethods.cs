...
namespace AssistantHub.Core.Database.Mysql.Implementations
{
    ...
    /// <summary>
    /// MySQL chat history performance event methods.
    /// </summary>
    public class ChatHistoryPerformanceEventMethods : IChatHistoryPerformanceEventMethods
    {
        ...
        /// <summary>
        /// Instantiate the MySQL performance-event data access layer.
        /// </summary>
        /// <param name="driver">MySQL database driver.</param>
        /// <param name="settings">Database settings.</param>
        /// <param name="logging">Logging module.</param>
        public ChatHistoryPerformanceEventMethods(MysqlDatabaseDriver driver, DatabaseSettings settings, LoggingModule logging)
        {
