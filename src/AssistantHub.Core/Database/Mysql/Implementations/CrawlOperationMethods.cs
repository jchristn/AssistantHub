namespace AssistantHub.Core.Database.Mysql.Implementations
{
    ...
    /// <summary>
    /// MySQL crawl operation methods implementation.
    /// </summary>
    public class CrawlOperationMethods : ICrawlOperationMethods
    {
        ...
        public CrawlOperationMethods(MysqlDatabaseDriver driver, DatabaseSettings settings, LoggingModule logging)
        {
        ...
        public async Task<CrawlOperation> ReadAsync(string id, CancellationToken token = default)
        {
            ...
            string query = "SELECT * FROM crawl_operations WHERE id = '" + _Driver.Sanitize(id) + "'";
        ...
        public async Task DeleteAsync(string id, CancellationToken token = default)
        {
            ...
            string query = "DELETE FROM crawl_operations WHERE id = '" + _Driver.Sanitize(id) + "'";
            await _Driver.ExecuteQueryAsync(query, true, token).ConfigureAwait(false);
        }
        ...
        public async Task<bool> ExistsAsync(string id, CancellationToken token = default)
        {
            ...
            string query = "SELECT COUNT(*) AS cnt FROM crawl_operations WHERE id = '" + _Driver.Sanitize(id) + "'";
            DataTable result = await _Driver.ExecuteQueryAsync(query, false, token).ConfigureAwait(false);
        ...
        public async Task<EnumerationResult<CrawlOperation>> EnumerateAsync(string tenantId, EnumerationQuery query, CancellationToken token = default)
        {
            ...
            List<CrawlOperation> objects = new List<CrawlOperation>();
            ...
            EnumerationResult<CrawlOperation> enumerationResult = new EnumerationResult<CrawlOperation>();
        ...
        public async Task DeleteByCrawlPlanAsync(string crawlPlanId, CancellationToken token = default)
        {
            ...
            string query = "DELETE FROM crawl_operations WHERE crawl_plan_id = '" + _Driver.Sanitize(crawlPlanId) + "'";
            await _Driver.ExecuteQueryAsync(query, true, token).ConfigureAwait(false);
        }
