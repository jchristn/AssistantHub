...
namespace AssistantHub.Core.Database.Postgresql.Implementations
{
    ...
    /// <summary>
    /// PostgreSQL assistant tool-call trace methods.
    /// </summary>
    public class AssistantToolCallMethods : IAssistantToolCallMethods
    {
        ...
        public AssistantToolCallMethods(PostgresqlDatabaseDriver driver, DatabaseSettings settings, LoggingModule logging)
        {
