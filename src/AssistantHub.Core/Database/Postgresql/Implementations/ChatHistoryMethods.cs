namespace AssistantHub.Core.Database.Postgresql.Implementations
{
    ...
    /// <summary>
    /// PostgreSQL chat history methods implementation.
    /// </summary>
    public class ChatHistoryMethods : IChatHistoryMethods
    {
        ...
        public ChatHistoryMethods(PostgresqlDatabaseDriver driver, DatabaseSettings settings, LoggingModule logging)
        {
