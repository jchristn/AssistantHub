...
namespace AssistantHub.Core.Database.Postgresql.Implementations
{
    ...
    /// <summary>
    /// PostgreSQL chat history performance event methods.
    /// </summary>
    public class ChatHistoryPerformanceEventMethods : IChatHistoryPerformanceEventMethods
    {
        ...
        /// <summary>
        /// Instantiate the PostgreSQL performance-event data access layer.
        /// </summary>
        /// <param name="driver">PostgreSQL database driver.</param>
        /// <param name="settings">Database settings.</param>
        /// <param name="logging">Logging module.</param>
        public ChatHistoryPerformanceEventMethods(PostgresqlDatabaseDriver driver, DatabaseSettings settings, LoggingModule logging)
        {
