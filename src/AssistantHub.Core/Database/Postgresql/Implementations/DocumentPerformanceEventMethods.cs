...
namespace AssistantHub.Core.Database.Postgresql.Implementations
{
    ...
    /// <summary>
    /// PostgreSQL document performance event methods.
    /// </summary>
    public class DocumentPerformanceEventMethods : IDocumentPerformanceEventMethods
    {
        ...
        /// <summary>
        /// Instantiate the PostgreSQL document performance-event data access layer.
        /// </summary>
        /// <param name="driver">PostgreSQL database driver.</param>
        /// <param name="settings">Database settings.</param>
        /// <param name="logging">Logging module.</param>
        public DocumentPerformanceEventMethods(PostgresqlDatabaseDriver driver, DatabaseSettings settings, LoggingModule logging)
        {
