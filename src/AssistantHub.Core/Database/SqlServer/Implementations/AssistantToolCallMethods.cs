...
namespace AssistantHub.Core.Database.SqlServer.Implementations
{
    ...
    /// <summary>
    /// SQL Server assistant tool-call trace methods.
    /// </summary>
    public class AssistantToolCallMethods : IAssistantToolCallMethods
    {
        ...
        public AssistantToolCallMethods(SqlServerDatabaseDriver driver, DatabaseSettings settings, LoggingModule logging)
        {
        ...
        public async Task<EnumerationResult<AssistantToolCallRecord>> EnumerateAsync(string tenantId, EnumerationQuery query, string assistantId = null, CancellationToken token = default)
        {
            ...
            string listQuery =
                ...
                " OFFSET " + skip + " ROWS FETCH NEXT " + query.MaxResults + " ROWS ONLY;";
