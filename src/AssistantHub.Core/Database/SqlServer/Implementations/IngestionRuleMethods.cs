...
namespace AssistantHub.Core.Database.SqlServer.Implementations
{
    ...
    /// <summary>
    /// SQL Server ingestion rule methods implementation.
    /// </summary>
    public class IngestionRuleMethods : IIngestionRuleMethods
    {
        ...
        public IngestionRuleMethods(SqlServerDatabaseDriver driver, DatabaseSettings settings, LoggingModule logging)
        {
        ...
        public async Task<EnumerationResult<IngestionRule>> EnumerateAsync(string tenantId, EnumerationQuery query, CancellationToken token = default)
        {
            ...
            string countQuery = "SELECT COUNT(*) AS cnt FROM ingestion_rules " + whereClause + ";";
