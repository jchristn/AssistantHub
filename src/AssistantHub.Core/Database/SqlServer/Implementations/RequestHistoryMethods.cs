namespace AssistantHub.Core.Database.SqlServer.Implementations
{
    ...
    public class RequestHistoryMethods : IRequestHistoryMethods
    {
        ...
        /// Instantiate.
        /// </summary>
        public RequestHistoryMethods(SqlServerDatabaseDriver driver, DatabaseSettings settings, LoggingModule logging)
        {
        ...
        public async Task<EnumerationResult<RequestHistoryEntry>> EnumerateAsync(RequestHistorySearchFilter filter, CancellationToken token = default)
        {
            ...
            string selectQuery =
                ...
                whereClause + " " +
                orderBy + " " +
                "OFFSET " + skip + " ROWS FETCH NEXT " + filter.MaxResults + " ROWS ONLY;";
