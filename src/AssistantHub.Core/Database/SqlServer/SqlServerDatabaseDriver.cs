    ...
    public class SqlServerDatabaseDriver : DatabaseDriverBase
    {
        ...
        public override async Task InitializeAsync(CancellationToken token = default)
        {
            List<string> queries = new List<string>
            {
                ...
                TableQueries.AddAssistantSettingsToolRoutingInferenceEndpointIdColumn,
                ...
                TableQueries.AddAssistantSettingsEnableAnswerabilityCheckColumn,
                TableQueries.AddAssistantSettingsAnswerabilityInferenceEndpointIdColumn,
                TableQueries.AddAssistantSettingsAnswerabilityModeColumn,
                TableQueries.AddAssistantSettingsAnswerabilityPromptColumn,
                TableQueries.AddAssistantSettingsLoadModelsOnChatOpenColumn,
                TableQueries.AddAssistantSettingsExposeThinkingColumn,
                TableQueries.AddAssistantSettingsToolPolicyJsonColumn,
                TableQueries.AddAssistantSettingsEnableDocumentAttachmentsColumn,
                TableQueries.AddAssistantSettingsDocumentAttachmentMaxCountColumn,
                TableQueries.AddAssistantSettingsExposeDocumentSourceUrlsColumn,
                ...
                TableQueries.AddAssistantDocumentsVerbexRecordIdColumn,
                TableQueries.CreateAssistantFeedbackTable,
                TableQueries.CreateIngestionRulesTable,
                TableQueries.AddIngestionRulesVerbexIndexIdColumn,
                ...
                TableQueries.AddChatHistoryAttachedDocumentIdsJsonColumn,
                TableQueries.AddChatHistoryAttachedDocumentsJsonColumn,
                TableQueries.AddChatHistoryQueryClassColumn,
                TableQueries.AddChatHistoryAnswerabilityDecisionColumn,
                TableQueries.AddChatHistoryAnswerabilityReasonColumn,
                TableQueries.AddChatHistoryDroppedCandidateCountColumn,
                TableQueries.AddChatHistoryDroppedCandidateSummaryJsonColumn,
                TableQueries.AddChatHistoryFinalCitationCountColumn,
                ...
                TableQueries.AddAssistantToolCallsInputBytesColumn,
                TableQueries.AddAssistantToolCallsOutputBytesColumn,
                TableQueries.AddAssistantToolCallsErrorTypeColumn,
                TableQueries.AddAssistantToolCallsProviderColumn,
                TableQueries.AddAssistantToolCallsModelColumn,
                TableQueries.AddAssistantToolCallsActiveColumn,
                TableQueries.AddAssistantToolCallsLastUpdateUtcColumn,
