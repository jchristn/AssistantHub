...
namespace AssistantHub.Core.Database.Sqlite.Implementations
{
    ...
    /// <summary>
    /// SQLite assistant feedback methods implementation.
    /// </summary>
    public class AssistantFeedbackMethods : IAssistantFeedbackMethods
    {
        #region Private-Members

        private readonly string _Header = "[AssistantFeedbackMethods] ";
        ...
        public AssistantFeedbackMethods(SqliteDatabaseDriver driver, DatabaseSettings settings, LoggingModule logging)
        {
        ...
        public async Task<AssistantFeedback> CreateAsync(AssistantFeedback feedback, CancellationToken token = default)
        {
            ...
            if (String.IsNullOrEmpty(feedback.Id)) feedback.Id = IdGenerator.NewAssistantFeedbackId();
        ...
        public async Task<AssistantFeedback> ReadAsync(string id, CancellationToken token = default)
        {
            ...
            string query =
                "SELECT * FROM assistant_feedback WHERE id = '" + _Driver.Sanitize(id) + "';";
        ...
        public async Task DeleteAsync(string id, CancellationToken token = default)
        {
            ...
            string query =
                "DELETE FROM assistant_feedback WHERE id = '" + _Driver.Sanitize(id) + "';";
        ...
        public async Task<EnumerationResult<AssistantFeedback>> EnumerateAsync(EnumerationQuery query, CancellationToken token = default)
        {
            ...
            string countQuery =
                "SELECT COUNT(*) AS cnt FROM assistant_feedback " + whereClauseCount + ";";
            ...
            if (selectResult != null && selectResult.Rows.Count > 0)
            {
                ...
                {
                    ret.Objects.Add(AssistantFeedback.FromDataRow(row));
                }
            }
        ...
        public async Task DeleteByAssistantIdAsync(string assistantId, CancellationToken token = default)
        {
            ...
            string query =
                "DELETE FROM assistant_feedback WHERE assistant_id = '" + _Driver.Sanitize(assistantId) + "';";
