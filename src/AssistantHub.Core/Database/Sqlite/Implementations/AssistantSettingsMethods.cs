    ...
    public class AssistantSettingsMethods : IAssistantSettingsMethods
    {
        ...
        public async Task<AssistantSettings> CreateAsync(AssistantSettings settings, CancellationToken token = default)
        {
            ...
            string query =
                ...
                "inference_endpoint_id, retrieval_gate_inference_endpoint_id, query_rewrite_inference_endpoint_id, rerank_inference_endpoint_id, embedding_endpoint_id, title, logo_url, favicon_url, retrieval_label_filter, retrieval_tag_filter, eval_judge_prompt, streaming, enable_slack, slack_app_token, slack_bot_token, slack_channel_id, slack_message_prefix, created_utc, last_update_utc) " +
                "VALUES (" +
