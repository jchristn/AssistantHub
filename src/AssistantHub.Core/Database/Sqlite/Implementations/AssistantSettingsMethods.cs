    ...
    public class AssistantSettingsMethods : IAssistantSettingsMethods
    {
        ...
        public async Task<AssistantSettings> CreateAsync(AssistantSettings settings, CancellationToken token = default)
        {
            ...
            string query =
                ...
                "enable_rag, collection_id, retrieval_top_k, retrieval_score_threshold, inference_endpoint_id, " +
                "embedding_endpoint_id, title, logo_url, favicon_url, streaming, created_utc, last_update_utc) " +
                "VALUES (" +
