...
namespace AssistantHub.Core.Database.Sqlite.Implementations
{
    ...
    /// <summary>
    /// SQLite ingestion rule methods implementation.
    /// </summary>
    public class IngestionRuleMethods : IIngestionRuleMethods
    {
        ...
        public IngestionRuleMethods(SqliteDatabaseDriver driver, DatabaseSettings settings, LoggingModule logging)
        {
        ...
        public async Task<IngestionRule> ReadAsync(string id, CancellationToken token = default)
        {
            ...
            string query =
                "SELECT * FROM ingestion_rules WHERE id = '" + _Driver.Sanitize(id) + "';";
        ...
        public async Task DeleteAsync(string id, CancellationToken token = default)
        {
            ...
            string query =
                "DELETE FROM ingestion_rules WHERE id = '" + _Driver.Sanitize(id) + "';";
        ...
        public async Task<bool> ExistsAsync(string id, CancellationToken token = default)
        {
            ...
            string query =
                "SELECT COUNT(*) AS cnt FROM ingestion_rules WHERE id = '" + _Driver.Sanitize(id) + "';";
        ...
        public async Task<IngestionRule> ReadByNameAsync(string tenantId, string name, CancellationToken token = default)
        {
            ...
            string query =
                "SELECT * FROM ingestion_rules WHERE tenant_id = '" + _Driver.Sanitize(tenantId) + "' AND name = '" + _Driver.Sanitize(name) + "';";
        ...
        public async Task<EnumerationResult<IngestionRule>> EnumerateAsync(string tenantId, EnumerationQuery query, CancellationToken token = default)
        {
            ...
            string countQuery =
                "SELECT COUNT(*) AS cnt FROM ingestion_rules WHERE tenant_id = '" + _Driver.Sanitize(tenantId) + "';";
